          ...
          <div className={styles.switcher}>
            ...
            <div className={`${styles.infoStack} ${styles.stack}`}>
              <p>
                ...
                opasnosti ukoliko je pojeo čokoladu i da li ima potrebe za
                brigu.
              </p>
              <p className="error">
                U slučaju bilo kakve nedoumice i sumnjivog ponašanja psa, uvek
                je najbolje konsultovati se sa veterinarom. Ovaj kalkulator ne
                bi trebao da bude zamena za stručnu medicinsku pomoć i savet.
              </p>
              <p>
                Čokolada sadrži teobromin koji je bezopasan za ljude, ali je
                veoma otrovan za pse. U čokoladi i sličnim proizvodima se nalazi
                i kofein. Kalkulator sabira dozu kofeina i teobromina i
                izračunava nivo toksičnosti.
              </p>
              <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Laborum deserunt, repellat nesciunt incidunt sit reiciendis at
                odit itaque provident quod earum iure vel, minus enim
                voluptatem. Nesciunt voluptatibus aperiam voluptate officiis!
                Inventore voluptate nobis dolor, quas adipisci quam similique
                reprehenderit.
              </p>
            </div>
          </div>
